...
function wydNotifyByBootstrapDirective(wydNotifyService) {
	return {
		...
		templateUrl : 'modules/wydNotify/wydNotifyByBootstrap.html',

		link : function($scope) {
			$scope.notifyService = wydNotifyService;
		}
	};
}
appDirectives.directive('wydNotifyByBootstrapDirective', [ 'wydNotifyService',
		wydNotifyByBootstrapDirective ]);
